...
- [x] T020 [P] Add representative fixtures verification script `specs/001-rework-data-models/scripts/verify-fixtures.sh` to validate each fixture against JSON schemas and run in CI — specs/001-rework-data-models/scripts/verify-fixtures.sh
